...
[x1, y1, confidence1, scale1] = get_interest_points(image1_bw, feature_width);
[x2, y2, confidence2, scale2] = get_interest_points(image2_bw, feature_width);

%% Create feature vectors at each interest point. Szeliski 4.1.2
% !!! You will need to implement get_features. !!!
scale2 = scale1 ./ scale2;
scale1 = 1;
[image1_features] = get_features(image1_bw, x1, y1, feature_width, scale1);
[image2_features] = get_features(image2_bw, x2, y2, feature_width, scale2);
